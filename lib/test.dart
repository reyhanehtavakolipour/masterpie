...
//             children: [
//               const SizedBox(height: 16,),
//               const Text(ADDED_FOODS, style: TextStyle(color: MASTERPIE_ORANGE_COLOR, fontWeight: FontWeight.bold, fontSize: 18),),
//               const SizedBox(height: 16,),
//               FoodsMacroListUi(foods: _requestWizardArgumentModel.foods, foodsExpansionState: _foodsExpansionState,
//                 onExpansionStateChanged: updateFoodsExpansionStateListUi, onRemoveFoodClicked: updateUiAfterFoodsUpdated, foodsServingRanges: _requestWizardArgumentModel.servingRanges,
//               )
//             ],
//           ),
//         )
...
//           _addFoodOptionsIsVisible= false;
//         });
//       }else{
//         if(state == true){
...
//
//
//   _updateWizardParams(bool clickedOnCalculateButton){
