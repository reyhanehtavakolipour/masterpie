...
part of 'generic_food_model.dart';
...
/// @nodoc
abstract class $GenericFoodCopyWith<$Res> {
  factory $GenericFoodCopyWith(
          GenericFood value, $Res Function(GenericFood) then) =
      _$GenericFoodCopyWithImpl<$Res, GenericFood>;
  @useResult
  $Res call(
      {String id,
      FoodType foodType,
...
/// @nodoc
class _$GenericFoodCopyWithImpl<$Res, $Val extends GenericFood>
    implements $GenericFoodCopyWith<$Res> {
  _$GenericFoodCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GenericFoodImplCopyWith<$Res>
    implements $GenericFoodCopyWith<$Res> {
  factory _$$GenericFoodImplCopyWith(
          _$GenericFoodImpl value, $Res Function(_$GenericFoodImpl) then) =
      __$$GenericFoodImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$GenericFoodImplCopyWithImpl<$Res>
    extends _$GenericFoodCopyWithImpl<$Res, _$GenericFoodImpl>
    implements _$$GenericFoodImplCopyWith<$Res> {
  __$$GenericFoodImplCopyWithImpl(
      _$GenericFoodImpl _value, $Res Function(_$GenericFoodImpl) _then)
      : super(_value, _then);
...
class _$GenericFoodImpl implements _GenericFood {
  _$GenericFoodImpl(
      {this.id = '',
  ...
  _$$GenericFoodImplCopyWith<_$GenericFoodImpl> get copyWith =>
      __$$GenericFoodImplCopyWithImpl<_$GenericFoodImpl>(this, _$identity);
}

abstract class _GenericFood implements GenericFood {
  factory _GenericFood(
      {final String id,
      final FoodType foodType,
      final String name,
      final String barcode,
      ...
      final double count,
      final String prepTime,
      final int createdFromFatSecretRecipes}) = _$GenericFoodImpl;
