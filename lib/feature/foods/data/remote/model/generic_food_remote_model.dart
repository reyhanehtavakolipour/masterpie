...
part 'generic_food_remote_model.freezed.dart';



@freezed
class GenericFoodRemote with _$GenericFoodRemote{

  factory GenericFoodRemote({
    @Default('') String id,
    @Default(FoodTypeRemote.meal) FoodTypeRemote foodType,
    @Default('') String name,
