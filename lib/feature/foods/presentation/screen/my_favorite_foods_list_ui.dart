...
class MyFavoritesFoodsListUi extends StatefulWidget {
  ...
  final Function(Food food) onFavoriteFoodClicked;
  final List<FoodType> foodsTypeRequested;
  final Color foodBackGroundColor;
  final Icon foodIcon;
  final bool macroEdition;

  const MyFavoritesFoodsListUi({super.key,required this.foodCalculator, required this.foods, required this.onFoodsChanged,
    required this.onRemoveButtonClicked, required this.onFavoriteFoodClicked, required this.foodsTypeRequested,
  required this.foodBackGroundColor, required this.foodIcon, required this.macroEdition});


  @override
  State<MyFavoritesFoodsListUi> createState() => _MyFavoritesFoodsListUiState();

  static _MyFavoritesFoodsListUiState? of(BuildContext context) {
    return context.findAncestorStateOfType<_MyFavoritesFoodsListUiState>();
  }
}

class _MyFavoritesFoodsListUiState extends State<MyFavoritesFoodsListUi> {
    ...
    return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: (){
                  widget.onFavoriteFoodClicked(food);
                },
                child: Card(
                              ...
                              PopupMenuButton<String>(
                                ...
                                <PopupMenuEntry<String>>[
                                  const PopupMenuItem<String>(
                                    value: REMOVE_FROM_FAVORITE_LABEL,
                                    child: ListTile(
                                      leading: Icon(Icons.delete),
                                      title: Text(REMOVE_FROM_FAVORITE_LABEL, style: TextStyle(fontFamily: MONTSERRAT_FONT),),
                                    ),
                                  ),
                                ],
                              ),
