...
//
//
//    List<int> _selectedIngredientsUnitIndex= [];
...
//           _selectedIngredientsUnitIndex.add(0);
...
//             newFood.servingIngredientsCount[i].isEmpty ? '0' : newFood.servingIngredientsCount[i][_selectedIngredientsUnitIndex[i]]);
//         calorie = calorie + double.parse(newFood.calorie[i].isEmpty ? '0' : newFood.calorie[i][_selectedIngredientsUnitIndex[i]]) * servingCount;
//       }
//     }
//
//     double protein = 0;
...
//       if (i < newFood.servingIngredientsCount.length) {
//         double servingCount = double.parse(newFood.servingIngredientsCount[i].isEmpty ? '0' : newFood.servingIngredientsCount[i][_selectedIngredientsUnitIndex[i]]);
//         protein = protein + double.parse(newFood.protein[i].isEmpty ? '0' : newFood.protein[i][_selectedIngredientsUnitIndex[i]]) * servingCount;
//       }
//     }
//
//     double carb = 0;
...
//       if (i < newFood.servingIngredientsCount.length) {
//         double servingCount = double.parse(newFood.servingIngredientsCount[i].isEmpty ? '0' : newFood.servingIngredientsCount[i][_selectedIngredientsUnitIndex[i]]);
//         carb = carb + double.parse(newFood.carb[i].isEmpty ? '0' : newFood.carb[i][_selectedIngredientsUnitIndex[i]]) * servingCount;
//       }
//     }
//
//
...
//       if (i < newFood.servingIngredientsCount.length) {
//         double servingCount = double.parse(newFood.servingIngredientsCount[i].isEmpty ? '0' : newFood.servingIngredientsCount[i][_selectedIngredientsUnitIndex[i]]);
//         fat = fat + double.parse(newFood.fat[i].isEmpty ? '0' : newFood.fat[i][_selectedIngredientsUnitIndex[i]]) * servingCount;
//       }
//     }
//
//
...
//              const SizedBox(height: 16,),
//              // RecipeIngredientsListUi(meal: newFood, ingredientsExpansionState: _ingredientsExpansionState,
