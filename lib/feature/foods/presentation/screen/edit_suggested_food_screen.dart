...
class EditSuggestedFoodScreen extends StatefulWidget {

  final FoodDetailArgumentModel foodDetailArgumentModel;

  const EditSuggestedFoodScreen({super.key, required this.foodDetailArgumentModel});

  @override
  State<EditSuggestedFoodScreen> createState() => _EditSuggestedFoodScreenState();
}

class _EditSuggestedFoodScreenState extends State<EditSuggestedFoodScreen> {
       ...
       children: [
         Container(
           ...
           child: ElevatedButton(
               ...
               child: Text(ADD_TO_MY_FAVORTITE,
