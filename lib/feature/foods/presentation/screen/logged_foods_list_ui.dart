...
import 'package:masterpie/feature/foods/presentation/screen/view_logged_food_screen.dart';
...
class LoggedFoodsListUi extends StatefulWidget {
  ...
  @override
  State<LoggedFoodsListUi> createState() => _LoggedFoodsListUiState();

  static _LoggedFoodsListUiState? of(BuildContext context) {
    return context.findAncestorStateOfType<_LoggedFoodsListUiState>();
  }
}
...
class _LoggedFoodsListUiState extends State<LoggedFoodsListUi> {
