...
class SuggestFoodMacroWizardScreen extends StatefulWidget {



  const SuggestFoodMacroWizardScreen({super.key});

  @override
  State<SuggestFoodMacroWizardScreen> createState() => _SuggestFoodMacroWizardScreenState();
}

class _SuggestFoodMacroWizardScreenState extends State<SuggestFoodMacroWizardScreen> {
