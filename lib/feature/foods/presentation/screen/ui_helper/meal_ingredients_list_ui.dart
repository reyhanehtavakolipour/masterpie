...
class MealIngredientsListUi extends StatefulWidget {
  ...
  final Function(Food food) onIngredientUpdated;
  final Food meal;
  ...
  MealIngredientsListUi({super.key, required this.meal, required this.ingredientsExpansionState,
    required this.onExpansionStateChanged, required this.onIngredientUpdated, required this.onServingCountChangeRequested, required this.isEditable, required this.ingredients});

  @override
  State<MealIngredientsListUi> createState() => _MealIngredientsListUiState();
}

class _MealIngredientsListUiState extends State<MealIngredientsListUi> {
