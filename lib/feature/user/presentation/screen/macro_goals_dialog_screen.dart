...
class _MacroGoalsPopupState extends State<MacroGoalsPopup> {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: GestureDetector(
                          ...
                          child: const Text(LET_US_CALCULATE_IT_MESSAGE, style: TextStyle(color: DARK_PRIMARY_COLOR, fontWeight: FontWeight.bold, fontSize: 12), textAlign: TextAlign.center,),
                        ),
                      ),
  ...
  void sendMacrosToMainScreen() {
    ...
    widget.onMacroGoalUpdated([calorie.toString(), protein.toString(), carb.toString(), fat.toString()]);
    Navigator.pop(context);
  }
