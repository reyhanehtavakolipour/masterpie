...
const SUGGEST_FOOD_LEFT= 'Recommend Recipe';
const MACRO_EDITION_ACCESS= 'Access to macro customization';
...
const USDA_NUTRITION_ACCESS= 'USDA Nutrition Database Access';
const FAVORITE_FOOD_ACCESS= 'Add new favorite food';
const MACRO_ADJUSTMENT_ACCESS= 'Customizable Macro';
const SUGGEST_FOOD_ACCESS= 'Personalized Meal Recommendation';
...
const UPGRADE_MSG_FAVORITE_FOOD= 'Upgrade to any of our premium/basic plans, granting you the ability to save as many favorite foods as you desire.';
const UPGRADE_MSG_COOKBOOK_FOOD= 'Upgrade to any of our premium/basic plans, granting you the ability to save as many cookBook foods as you desire.';
...
const UPGRADE_MSG_SUGGEST_FOOD= 'Upgrade to any of our premium/basic plans to unlock the ability to use the "Recommend Recipe" feature in the app.';
const UPGRADE_MSG_FOODS_PORTION= 'Upgrade to any of our premium/basic plans to unlock the ability to use the "Macro Diet Wizard" feature in the app.';
